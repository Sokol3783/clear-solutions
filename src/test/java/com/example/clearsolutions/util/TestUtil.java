...
public class TestUtil {
  ...
  public static List<User> getTestUsers(){
    return List.of(
        User.builder().email("example@gmail.com").phone("phone").firstName("first_name1").lastName("last_name")
            .birthDate(new OffsetBuilder(1993).build()).build(),
        User.builder().email("example@gmail.com").phone("phone").firstName("first_name1").lastName("last_name2")
            .birthDate(new OffsetBuilder(1958).build()).build(),
        User.builder().email("example@gmail.com").phone("phone").firstName("first_name1").lastName("last_name3")
            .birthDate(new OffsetBuilder(2000).build()).build());

  }

  public static User getTestUser() {
    return User.builder().email("example@gmail.com").phone("phone").firstName("first_name1").lastName("last_name")
        .birthDate(new OffsetBuilder(1993).build()).build();
  }
